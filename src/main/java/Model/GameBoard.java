...
public class GameBoard {
    ...
    private Field[] createFields() {
        return new Field[]{
                ...
                new ShippingField(stringContainer.getString("field_ship_1_title"), 4000,100, stringContainer.getString("field_ship_rent")),
                ...
                new ShippingField(stringContainer.getString("field_ship_2_title"), 4000,0, stringContainer.getString("field_ship_rent")),
                ...
                new ShippingField(stringContainer.getString("field_ship_3_title"), 4000,100, stringContainer.getString("field_ship_rent")),
                ...
                new ShippingField(stringContainer.getString("field_ship_4_title"), 4000,100, stringContainer.getString("field_ship_rent")),
                new ChanceField(stringContainer.getString("field_chance")),
